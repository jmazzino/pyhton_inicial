...
class Ventana:
    ...
    def __init__(self, window):
        ...
        def f_muestra():
            """
            Metodo f_muestra, esta destinado a realizar una actualizacion de la informacion que se muestra en el treeview
            """

            def conectar():
                """
                Metodo interno de f_muestra, esta destinado a realizar la conexion con la db
                """
                try:
            ...
            def mostrarregistro(con):
                """
                Metodo interno de f_muestra, esta destinado a realizar la limpieza del Treeview
                """
                # limpieza de tabla
                records = tree.get_children()
                for element in records:
            ...
            if MsgBox == "yes":
                ...
                if not id:
                    ...
                    def buscarregistro(con):
                        ...
                        # Consiguiendo datos
                        sql = "SELECT * FROM personas where id = {} ORDER BY id DESC".format(
                            id
                        )
